...
class TextCaps(Dataset):
    def __init__(
        ...
        metadata_root_dir : Path
            Directory where contain TextCaps-vi en/, vi/...
        iso639_1_code : str
    ...
    def __getitem__(self, index) -> dict:
        ...
        -------
        dict
            See https://textvqa.org/textcaps/dataset/#:~:text=suggestions%20and%20feedback.-,Description,-TextCaps%20JSON%20files
            and https://huggingface.co/datasets/dinhanhx/TextCaps-vi
        """
