...
class VQAv2(Dataset):
    def __init__(
        ...
        metadata_root_dir : Path
            Directory where contain VQAv2-vi en/, vi/...
        iso639_1_code : str
        ...
        ), f"{iso639_1_code}/v2_OpenEnded_mscoco_train2014_questions.json does not exist"
        ...
        ), f"{iso639_1_code}/v2_OpenEnded_mscoco_train2014_answers.json does not exist"
